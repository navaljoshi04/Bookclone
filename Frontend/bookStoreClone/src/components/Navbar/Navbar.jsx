      ...
      >
        <div className="navbar ">
          <div className="navbar-start">
            ...
            <a className="text-3 font-bold cursor-pointer">bookStore</a>
          </div>
          <div className="navbar-end space-x-3">
            ...
            <div className="hidden md:block">
              <label className="input input-bordered flex items-center gap-2 rounded-md  dark:bg-slate-900 dark:text-white">
                <input
                  type="text"
